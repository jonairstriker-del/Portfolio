...
export const PLATFORMS = [
  ...
  },
  {
    ...
    name:        "TikTok — ×STRIKER×",
    handle:      "@striker.only",
    url:         "https://tiktok.com/@striker.only",
    image:       "/images/tiktok-profile.jpg",
    joined:      null,
    stats: [
      { label: "Followers", value: "156"   },
      { label: "Likes",     value: "2243"  },
      { label: "Following", value: "27"    },
    ],
    description:
      "I joined TikTok to enhance my editing skills, begin livestreaming, and create an additional source of income. Using TikTok LIVE Studio I stream interactive sessions — leveraging gifts, Super Fan subscriptions, and live viewer engagement to build a growing online presence. Content includes gaming clips, anime edits, and Mobile Legends highlights.",
    tags:  ["Live Streaming", "Gaming Content", "Anime Edits", "Mobile Legends"],
    color: "#69C9D0",
    icon:  "tt",
  },
];
